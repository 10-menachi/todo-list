...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_addTask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/addTask */ \"./src/modules/addTask.js\");\n/* harmony import */ var _modules_clearCompleted__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/clearCompleted */ \"./src/modules/clearCompleted.js\");\n/* harmony import */ var _modules_deleteTask__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/deleteTask */ \"./src/modules/deleteTask.js\");\n/* harmony import */ var _modules_getTasks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/getTasks */ \"./src/modules/getTasks.js\");\n/* harmony import */ var _modules_refreshList__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/refreshList */ \"./src/modules/refreshList.js\");\n/* harmony import */ var _modules_setCompleted__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/setCompleted */ \"./src/modules/setCompleted.js\");\n/* harmony import */ var _modules_showTasks__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/showTasks */ \"./src/modules/showTasks.js\");\n/* harmony import */ var _styles_main_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./styles/main.css */ \"./src/styles/main.css\");\n/* eslint-disable no-use-before-define */\n\n\n\n\n\n\n\n\n\nconst listElem = document.querySelector('.list');\nconst form = document.querySelector('.add-task');\nconst tasks = (0,_modules_getTasks__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n(0,_modules_showTasks__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(listElem, tasks);\n\nform.addEventListener('submit', (e) => {\n  e.preventDefault();\n  const input = document.querySelector('.task-input');\n  (0,_modules_addTask__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(input.value);\n  updateTaskList();\n  form.reset();\n});\n\nconst setupDeleteButtons = () => {\n  const deleteButtons = document.querySelectorAll('.delete');\n  deleteButtons.forEach((button) => {\n    button.addEventListener('click', (e) => {\n      const id = e.target.dataset.taskId;\n      (0,_modules_deleteTask__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(id, listElem);\n      updateTaskList();\n    });\n  });\n};\n\nconst setupEditButtons = () => {\n  const listText = document.querySelectorAll('span');\n  listText.forEach((text) => {\n    text.addEventListener('click', (e) => {\n      const id = e.target.parentElement.parentElement.dataset.taskId;\n      const input = document.createElement('input');\n      input.type = 'text';\n      input.classList.add('edit-input');\n      input.value = e.target.textContent;\n      input.style.width = '100%';\n      input.style.outline = 'none';\n      input.style.border = 'none';\n      e.target.replaceWith(input);\n      input.focus();\n      input.addEventListener('blur', () => {\n        editTask(id, input.value);\n      });\n    });\n  });\n};\n\nconst setUpCheckBoxes = () => {\n  const checkBoxes = document.querySelectorAll('input[type=\"checkbox\"]');\n  checkBoxes.forEach((checkBox) => {\n    checkBox.addEventListener('change', (e) => {\n      const taskId = Number(e.target.parentElement.parentElement.dataset.taskId);\n      const { checked } = e.target;\n      (0,_modules_setCompleted__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(taskId, checked);\n      updateTaskList();\n    });\n  });\n};\n\nconst editTask = (id, newText) => {\n  const tasks = (0,_modules_getTasks__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  const index = tasks.findIndex((task) => task.id === Number(id));\n\n  if (index !== -1) {\n    tasks[index].name = newText;\n    localStorage.setItem('tasks', JSON.stringify(tasks));\n  }\n  updateTaskList();\n};\n\nconst updateTaskList = () => {\n  listElem.innerHTML = '';\n  const tasks = (0,_modules_getTasks__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\n  (0,_modules_showTasks__WEBPACK_IMPORTED_MODULE_6__[\"default\"])(listElem, tasks);\n  setupDeleteButtons();\n  setupEditButtons();\n  setUpCheckBoxes();\n};\n\nsetupDeleteButtons();\nsetupEditButtons();\nsetUpCheckBoxes();\n\nconst completed = document.querySelector('.clear');\ncompleted.addEventListener('click', () => {\n  (0,_modules_clearCompleted__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n  updateTaskList();\n});\n\nconst refresh = document.querySelector('.refresh');\nconsole.log(refresh);\nrefresh.addEventListener('click', () => {\n  (0,_modules_refreshList__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n  updateTaskList();\n});\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _getTasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getTasks */ \"./src/modules/getTasks.js\");\n/* harmony import */ var _Task__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Task */ \"./src/modules/Task.js\");\n\n\n\nconst addTask = (index) => {\n  const t = (0,_getTasks__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n  const task = new _Task__WEBPACK_IMPORTED_MODULE_1__[\"default\"](t.length, index, false);\n  const tasks = (0,_getTasks__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n  tasks.push(task);\n  localStorage.setItem('tasks', JSON.stringify(tasks));\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (addTask);\n\n//# sourceURL=webpack://todo-list/./src/modules/addTask.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst refreshList = () => localStorage.setItem('tasks', JSON.stringify([]));\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (refreshList);\n\n//# sourceURL=webpack://todo-list/./src/modules/refreshList.js?");

/***/ }),

/***/ "./src/modules/setCompleted.js":
/*!*************************************!*\
  !*** ./src/modules/setCompleted.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _getTasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getTasks */ \"./src/modules/getTasks.js\");\n\n\nconst setCompleted = (taskId, checked) => {\n  const tasks = (0,_getTasks__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n  const index = tasks.findIndex((task) => task.id === taskId);\n  tasks[index].done = checked;\n  localStorage.setItem('tasks', JSON.stringify(tasks));\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (setCompleted);\n\n//# sourceURL=webpack://todo-list/./src/modules/setCompleted.js?");
